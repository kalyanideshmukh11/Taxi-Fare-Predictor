...
#Load data 
train_dataset = pd.read_csv("./train.csv",nrows= 3000000)
...
def distance_travelled(df):
    df['Distance_Travelled'] = haversine_distance(df.dropoff_longitude,df.dropoff_latitude,df.pickup_longitude,df.pickup_latitude)
